...
#define PIN_ADS1115_ALERT                                                      \
  19 // ADS1115 ALERT/RDY pin (Active-LOW, pullup enabled)
...
// --- DS18B20 OneWire Bus ---
#define PIN_DS18B20 4 // Both temperature sensors on same bus (GPIO 4)

// --- Power Switch / Deep Sleep Wake-Up ---
#define PIN_POWER_SWITCH                                                       \
  27 // RTC_GPIO17: Power switch input (LOW = sleep after timeout, HIGH = wake)
